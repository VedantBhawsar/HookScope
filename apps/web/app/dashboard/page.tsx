  ...
  if (!selectedProject) {
    return (
      <section className="space-y-6">
        <header className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Overview</p>
          <h1 className="mt-2 font-heading text-3xl font-semibold">No project selected</h1>
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
            Create a project from onboarding to start seeing project-level observability data.
          </p>
        </header>
      </section>
    )
  ...
  return (
    <section className="space-y-6">
      <header className="rounded-2xl border border-border bg-card p-6 shadow-sm">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
          This dashboard is now scoped to the selected project. Next we can plug in deliveries, event stream, and
          analytics modules.
        </p>
      </header>
